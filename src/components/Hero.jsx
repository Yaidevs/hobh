    ...
    return (
      <div className="relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 text-center relative z-10">
          <h1 className="text-6xl md:text-7xl font-black tracking-tight leading-tight mb-6 animate-fade-in">
            CRUSH YOUR
            <br />
            SCHOOLWORK
          </h1>
          ...
          <button 
            className="bg-[#CDFF7B] hover:bg-[#CDFF7B]/90 text-black px-8 py-4 rounded-full text-lg font-semibold transition-colors"
          >
            Sign up for free
          </button>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-20">
            ...
            <div className="bg-gray-50 p-6 rounded-xl">
              <h3 className="font-bold mb-2">Personal study plans designed just for you</h3>
              <p className="text-sm text-gray-600">
                Ace your tests, quizzes, and exams with AI-powered Test Prep
              </p>
            </div>
            <div className="bg-gray-50 p-6 rounded-xl">
              <h3 className="font-bold mb-2">Instant answers unlock infinite discoveries</h3>
              <p className="text-sm text-gray-600">
